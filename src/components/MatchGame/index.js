...
class MatchGame extends Component {
  ...
  render() {
    const {selectedTab, score, img, timer, isGameEnd} = this.state
    const selectedTabImages = imagesList.filter(
            ...
            <div>
              <ul className="cont2">
                <li className="img-cont">
                  <img className="img" src={img} alt="match" />
                </li>
                <div className="tab-cont">
                  {tabsList.map(eachTab => (
                    <TabItem
                      ...
                      tabDetails={eachTab}
                      key={eachTab.tabId}
                      isActive={eachTab.tabId === selectedTab}
                    />
                  ))}
                </div>
              </ul>
              <ul className="thumbnail-cont">
                {selectedTabImages.map(eachImage => (
                  <ThumbnailImages
                    ...
                    key={eachImage.id}
                    checkWithImg={this.checkWithImg}
                  />
                ))}
              </ul>
            </div>
